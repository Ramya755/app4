  ...
  void checkLogin() {
    ...
    if (user.isEmpty) {
      ...
      Navigator.push(context,
          MaterialPageRoute(builder: (context) => MainScreen(name: enteredUsername)));
    }
  }
      ...
      body: Container(
        decoration: const BoxDecoration(
          image: DecorationImage(
            image: NetworkImage(
              'https://plus.unsplash.com/premium_photo-1675603849760-fce371511327?w=600&auto=format&fit=crop&q=60',
            ),
            fit: BoxFit.cover,
          ),
        ),
                      ...
                      children: [
                        ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            backgroundColor:
                                isAdmin ? Colors.teal : Colors.grey.shade400,
